                    ...
                    <div class="container mx-auto mt-5">
                        ...
                        <form action="{{ route('product-store') }}" method="POST" class="space-y-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name="unit" id="unit" class="block w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="information" id="information" class="block w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Submit</button>
                        </form>
                    </div>
